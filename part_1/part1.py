...
try:
    ...
    data_c.execute('create table users(uid varchar(20) PRIMARY KEY, permission varchar(10));')
    data_c.execute('insert into users values("user1", "read")')
    data_c.execute('insert into users values("user2", "write")')
